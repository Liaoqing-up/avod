...
def main():
    ...
    # results_file = '/opt/sdatmp/lq/project/gitproject/avod/scripts/offline_eval/results/pyramid_cars_with_aug_example_senet_second_sam_resnet_multi_focalloss_3classes_results_0.1.txt'
    results_file = '/opt/sdatmp/lq/project/gitproject/avod/scripts/offline_eval/results/pyramid_cars_with_aug_example_senet_second_sam_resnet_channel32_3classes_results_0.1.txt'
