...
class SeModule():
    ...
    def build(self, bev_feature_maps_org, img_feature_maps_org):
        with tf.variable_scope('bev_img_senet'):
            ...
            bev_feature_line_avg = slim.avg_pool2d(bev_feature_maps_org, [hb, wb], padding='valid')
            img_feature_line_avg = slim.avg_pool2d(img_feature_maps_org, [hi, wi], padding='valid')

            bev_feature_line_max = slim.max_pool2d(bev_feature_maps_org, [hb, wb], padding='valid')
            img_feature_line_max = slim.max_pool2d(img_feature_maps_org, [hi, wi], padding='valid')
